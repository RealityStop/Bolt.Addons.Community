...
{
    [NodeGenerator(typeof(OnCollisionStay))]
    public class OnCollisionStayGenerator : UnityMethodGenerator<OnCollisionStay, Collision>
    {
        public OnCollisionStayGenerator(Unit unit) : base(unit)
        {
        }
