...
{
    [NodeGenerator(typeof(OnCollisionExit2D))]
    public class OnCollisionExit2DGenerator : UnityMethodGenerator<OnCollisionExit2D, Collision2D>
    {
        public OnCollisionExit2DGenerator(Unit unit) : base(unit)
        {
        }
