    ...
    public static partial class PathUtil
    {
        ...
        public static string RootCommunityFolder
        {
            get
            {
                ...
                {
                    _rootCommunityFolder = PathOf("bolt_addons_community_root");
                }
        ...
        public static string FundamentalsEditorFolder => CommunityEditorFolder + "Nodes/Fundamentals/";
        public static string FundamentalsRuntimeFolder => CommunityRuntimeFolder + "Nodes/Fundamentals/";

        public static string EventsEditorFolder => CommunityEditorFolder + "Nodes/Events/";
        public static string EventsRuntimeFolder => CommunityRuntimeFolder + "Nodes/Events/";
