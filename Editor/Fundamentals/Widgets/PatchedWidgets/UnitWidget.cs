...
namespace Unity.VisualScripting.Community
{
    public class UnitWidget<TUnit> : NodeWidget<FlowCanvas, TUnit>, IUnitWidget where TUnit : class, IUnit
    {
        ...
        private Rect SnapTarget(IGraphElement e)
        {
            if (e is Unit unit)
            {
        ...
        protected virtual bool isSpecialPortsColor => _isSpecialColor;
                ...
                foreach (var setting in settings)
                {
                    ...
                    using (LudiqGUIUtility.currentInspectorWidth.Override(settingWidth))
                    {
                        ...
                        if (setting != last)
                        {
                            ...
                            headerHeight += settingHeight + Styles.spaceBetweenSettings;
                        }
                        else
                        {
                            y += settingHeight - Styles.spaceBetweenSettings;
