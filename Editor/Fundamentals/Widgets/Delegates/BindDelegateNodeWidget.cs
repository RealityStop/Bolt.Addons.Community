...
{
    public abstract class BindDelegateNodeWidget<T, TDelegate> : UnitWidget<T>
        where T : BindDelegateNode<TDelegate>
        where TDelegate : IDelegate
    {
        public BindDelegateNodeWidget(FlowCanvas canvas, T unit) : base(canvas, unit)
        {
        }
