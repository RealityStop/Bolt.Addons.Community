...
{
    [Widget(typeof(CustomEvent))]
    public class CustomEventWidget : UnitWidget<CustomEvent>
    {
        public CustomEventWidget(FlowCanvas canvas, CustomEvent unit) : base(canvas, unit)
        {
        }
