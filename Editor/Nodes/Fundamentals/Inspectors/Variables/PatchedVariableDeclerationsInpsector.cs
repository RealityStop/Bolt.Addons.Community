...
#pragma warning restore 618
        ...
        private void DrawQuickAddToolbar(Rect position)
        {
            ...
            for (int i = 0; i < quickTypesLabels.Length; i++)
            {
                ...
                if (DrawRoundedButton(buttonRect, quickTypesLabels[i], out var mouse))
                {
        ...
        private static GUIStyle labelStyle
        {
            get
            {
                ...
                {
                    border = new RectOffset((int)CornerRadius, (int)CornerRadius, (int)CornerRadius, (int)CornerRadius),
        ...
        private static bool DrawRoundedButton(Rect rect, GUIContent content, out MouseButton? mouseButton)
        {
            var e = Event.current;
            ...
            {
                color = CommunityStyles.backgroundColor;
            }
            else if (containsMouse)
            {
                color = CommunityStyles.backgroundColor.Brighten(0.3f);
            }
