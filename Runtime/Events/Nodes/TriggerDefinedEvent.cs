...
#pragma warning restore
        ...
        private ControlOutput Trigger(Flow flow)
        {
            ...
            if (IsRestricted)
            {
                ...
                DefinedEventNode.Trigger(flow.GetValue<GameObject>(EventTarget), instance);
            }
            else
            {
                DefinedEventNode.Trigger(flow.GetValue<GameObject>(EventTarget), flow.GetValue(inputPorts[0]));
            }
