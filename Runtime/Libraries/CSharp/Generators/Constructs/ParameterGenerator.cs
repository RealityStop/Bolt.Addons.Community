...
namespace Unity.VisualScripting.Community.Libraries.CSharp
{
    ...
    public sealed class ParameterGenerator : ConstructGenerator
    {
        ...
        public override string Generate(int indent)
        {
            ...
            return useAssemblyQualifiedType ? param + assemblyQualifiedType + " " + name.VariableHighlight() : ((modifier != ParameterModifier.None) ? modifier.ToString().ToLower().ConstructHighlight() + " " : string.Empty) + param + type.As().CSharpName() + " " + name.LegalMemberName().VariableHighlight();
        }
