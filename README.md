...
| :--- | :--- | :--- |
| [**Code**](https://github.com/RealityStop/Bolt.Addons.Community/wiki/C%23-Generation) (Experimental) | Class, Delegates, Enums, Interface, Struct | Essential Visual Scripting to C# building blocks. |
